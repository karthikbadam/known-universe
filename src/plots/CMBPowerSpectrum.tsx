...
// dataStatus: "simulated" — the network fetch for the real Planck 2018
// binned Dℓ failed (host allowlist). To swap to real data, see
      ...
      citation={
        <Citation title="Data source & provenance">
          ...
          <Text mt={2}>
            See{" "}
            <Link
              href="https://github.com/karthikbadam/known-universe/blob/feat/cosmology-clean/scripts/fetch/cmb_powerspectrum.md"
              isExternal
            >
              /scripts/fetch/cmb_powerspectrum.md
            </Link>{" "}
