    ...
    <Box as="section" bg="navy.800" py={{ base: 12, md: 16 }} px={{ base: 4, md: 6 }}>
      <Box maxW="6xl" mx="auto">
        ...
        <SimpleGrid columns={{ base: 1, md: 3 }} gap={5}>
          ...
          <ParamSlider label="Ω_c h²" description={PARAM_DESCRIPTIONS[1]!.controls} min={0.08} max={0.18} step={0.001} value={omegaCh2} onChange={setOmegaCh2} />
          <ParamSlider label="H₀" unit="km/s/Mpc" description={PARAM_DESCRIPTIONS[2]!.controls} min={50} max={90} step={0.1} value={H0} onChange={setH0} />
          <ParamSlider label="τ" description={PARAM_DESCRIPTIONS[3]!.controls} min={0.02} max={0.12} step={0.001} value={tau} onChange={setTau} />
          <ParamSlider label="ln(10¹⁰ A_s)" description={PARAM_DESCRIPTIONS[4]!.controls} min={2.8} max={3.3} step={0.005} value={as_} onChange={setAs} />
