...
scientific fields. Module 01 is Cosmology: a single-page scroll through ten plots that
build the ΛCDM model, each with parameter sliders that re-derive the curve in
real time. Future modules will cover other scientific areas in the same
format.
